const texts = {
  ...
  volume_24h: 'Volume(24h) in ',
  fee_24h: 'LP Fees(24h) in ',
  ...
  newpair_desc3: 'The tokenID of the new token',
  ...
  pay_fee: 'Pay fee',
  finish: 'Finish',
  enter_tokenid: 'Enter TokenID ',
  enter_mvc_or_tokenid: 'Enter MVC or Token Genesis ID',
  find_tokenid: 'TokenID can be found on',
